"""Anthropic provider implementation using structured outputs."""
...
class AnthropicProvider(LLMProvider):
    """Anthropic implementation using structured outputs for reliable JSON parsing."""
    ...
    def __init__(self, api_key: str, model: Optional[str] = None):
        ...
        Args:
            ...
            model: Model to use (e.g., "claude-haiku-4-5"). If None, uses prompt default.
        """
    ...
    def categorize_transactions(
        ...
        """Categorize transactions using Anthropic with structured outputs.
        ...
        logger.info(
            f"Calling Anthropic to categorize {len(transactions)} transaction(s) "
        ...
        model = self.model or rendered_prompt["parameters"].get(
        ...
        # Call Anthropic with structured outputs
        try:
            response = self.client.messages.parse(
                ...
                output_format=CategorizationResponse,
            )
            ...
            if result is None:
                logger.warning("Anthropic returned null parsed response")
                return []
